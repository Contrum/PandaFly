package dev.panda.combofly.utilities.tablist.v1_8.layout;
...
public class TabLayout {
	...
	public TabLayout(Tablist_v1_8 instance, Player player) {
	...
	private void fetchPing(int index, GameProfile gameProfile, int ping) {
		...
		if(Objects.equals(lastConnection, ping)) return;
	...
	private void fetchSkin(int index, GameProfile gameProfile, Skin skin) {
		...
		if(Objects.equals(skin, lastSkin)) return;
