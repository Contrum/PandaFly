package dev.panda.combofly.utilities.tablist.v1_7.layout;
...
public class TabLayout {
	...
	private final Tablist_v1_7 instance;
	private final Player player;
	
	public TabLayout(Tablist_v1_7 instance, Player player) {
	...
	public void create() {
		for(int row = 0; row < 20; row++) {
			for(int column = 0; column < 3l; column++) {
				...
				fakeGameProfile.getProperties().put(Skin.TEXTURE_KEY, property);
