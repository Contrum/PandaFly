...
public class MenuKitManager {
    ...
    public ItemStack getKitsDefault(String kit) {
        ...
        meta.setDisplayName(CC.translate("&c" + kit + " &7kit"));
    ...
    public ItemStack getBack() {
        ...
        ItemMeta meta = item.getItemMeta();
        meta.setDisplayName(CC.translate("&7«« &b&lBack &7««"));
        item.setItemMeta(meta);
        return item;
    }
    ...
    public ItemStack getSaveInv() {
        ...
        ItemMeta meta = item.getItemMeta();
        meta.setDisplayName(CC.translate("&c&lSave Kit"));
        meta.setLore(CC.translate(Arrays.asList(
                "&7&m-------------------------------",
    ...
    public ItemStack getCooldown(String kit) {
        ...
        ItemMeta meta = item.getItemMeta();
        meta.setDisplayName(CC.translate("&c&lCooldown Kit"));
        meta.setLore(CC.translate(Arrays.asList(
                "&7&m-------------------------------",
    ...
    public ItemStack getGoEditor() {
        ...
        ItemMeta meta = item.getItemMeta();
        meta.setDisplayName(CC.translate("&c&lGo to Editor"));
        meta.setLore(CC.translate(Arrays.asList(
                "&7&m-------------------------------",
    ...
    public ItemStack getToggle(String kit) {
        ...
        ItemMeta meta = item.getItemMeta();
        meta.setDisplayName(CC.translate("&c&lToggle Kit"));
        meta.setLore(CC.translate(Arrays.asList(
                "&7&m-------------------------------",
    ...
    public ItemStack getDefaultKit() {
        ...
        ItemMeta meta = item.getItemMeta();
        meta.setDisplayName(CC.translate("&cDefault Kit"));
        meta.setLore(CC.translate(Arrays.asList(
                "&7&m-------------------------------",
